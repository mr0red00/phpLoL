    ...
    class SabreAMF_AMF3_Serializer extends SabreAMF_Serializer {
        ...
        public function writeAMFData($data,$forcetype=null) {
           ...
           $this->stream->writeByte($type);
                ...
                if($type == SabreAMF_AMF3_Const::DT_OBJECT && $data instanceof SabreAMF_ITypedObject){
                    if($data->getAMFClassName() == null){
                        $type = SabreAMF_AMF3_Const::DT_XMLSTRING;
                        $this->stream->writeByte($type);
           ...
           switch ($type) {
                ...
                case SabreAMF_AMF3_Const::DT_XMLSTRING   : $this->writeXMLString($data); break;
        ...
        /**
         * Fakes XML String / Dynamic object
         * 
         * @param Object $data
         * @return void
         */
        public function writeXMLString($data) {
